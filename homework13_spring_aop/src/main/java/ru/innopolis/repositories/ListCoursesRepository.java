...
public class ListCoursesRepository {
    ...
    private static final String FIND_All_STUDENTS ="SELECT * FROM student.list_courses WHERE id_course=?";
    ...
    private Optional<ListCourses> findById(Long id) {
    ...
    public List<ListCourses> findListStudentsCourse(Long id_course){
        return template.query(FIND_All_STUDENTS, listCoursesRowMapper, id_course);
    }
