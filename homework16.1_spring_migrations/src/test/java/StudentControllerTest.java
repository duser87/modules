...
public class StudentControllerTest {
    ...
    void findByIdTest() throws Exception{
        ...
        mockMvc.perform(MockMvcRequestBuilders.get("/api/v1/student/2")).andExpectAll(MvcResult::getResponse);
    }
    ...
    @Test
    void methodCreateReviewTest() throws Exception{
        StudentRequest request = new StudentRequest();
        request.setId(1L);
        request.setId_student(1L);
        request.setId_course(2L);
        request.setReview("Тест");
        Mockito.doThrow(new RuntimeException()).when(Mockito.mock(StudentsController.class)).methodCreateReview(request);
        mockMvc.perform(MockMvcRequestBuilders.post("/api/v1/student/review")).andExpectAll(MvcResult::getResponse);
