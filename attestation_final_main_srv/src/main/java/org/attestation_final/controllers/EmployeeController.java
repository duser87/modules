...
/**
 *  Класс контроллера, обрабатывающий запросы по URL- localhost:8080/api/v1/main/employee
 */
@Slf4j
@RestController
...
public class EmployeeController {
     ...
     */
    @Operation(summary = "Метод получения объекта записи о работнике из БД", description = "Получение записи о работнике по ID")
    @ApiResponse(responseCode = "200", description = "Получение записи о работнике по ID")
